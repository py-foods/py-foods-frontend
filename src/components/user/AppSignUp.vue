...
<!--                  </div>-->
                  ...
                  <input id="n-password2-2" type="password" placeholder="Confirm Password">
                  <input id="n-email" type="text" placeholder="Email">
                  <input id="n-phone" type="text" placeholder="Phone Number">
                  <input id="n-address" type="text" placeholder="Address">
               ...
               <a href="javascript:void(0);">connect with <span>facebook</span></a>
            </div>
